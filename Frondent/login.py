...
# login frame widgets
# 1
email_label = Label(width="15", padx="5", pady="5", text="User Email", bg="deep sky blue", fg="yellow2",
                    font=("Calibri", 20, 'bold'))
email_label.place(x="165", y="170")
# 2
email_entry = Entry(textvariable=email, width="26", selectbackground="deep sky blue", selectforeground="black",
                    font=("Calibri", 15, "italic"))
email_entry.place(x="215", y="210")
# 3
password_label = Label(width="15", padx="5", pady="5", text="User Password", bg="deep sky blue", fg="yellow2",
                       font=("Calibri", 20, 'bold'))
password_label.place(x="188", y="240")
# 4
password_entry = Entry(textvariable=password, show="*", width="26", selectbackground="deep sky blue",
                       selectforeground="black", font=("Calibri", 15, "italic"))
password_entry.place(x="215", y="280")
# 5
login_btn = Button(text="Log In", width="23", font=("Arial", 14, "italic"), bg="yellow2", fg="deep sky blue",
                   command=validation)
login_btn.place(x="218", y="330")
# 6
txt = Label(text="not a member?", font=("Clibri", 12, "italic"), bg="deep sky blue", fg="white").place(x="230", y="390")
# 7
sgnup_btn = Button(text="Sign up now", width="14", font=("Calibri", 10, "bold"), bg="deep sky blue", fg="white",
                   command=shifting_form).place(x="347", y="390")
